...
class StanetProcess:
    def __init__(self, current_number, file_name, with_load=False):
        ...
        self.NETWORK_FILE_without_load = r' /N="C:\Users\D.Muehlfeld\Documents\aktuelle Berechnungen\Spechebach_Rechennetzmodell_Wasser\11_Netz_RNAB\Spechbach_Roughness_without_load.STA"'
        self.NETWORK_FILE_with_load = r' /N="C:\Users\D.Muehlfeld\Documents\aktuelle Berechnungen\Spechebach_Rechennetzmodell_Wasser\11_Netz_RNAB\Spechbach_Roughness_with_load.STA"'
        ...
        self.EXPORT_FILE_without_load = fr' /E="C:\Users\D.Muehlfeld\Documents\Synthetic_Data\Synthetic_Data_Roughness\SyntheticData-Spechbach_Roughness_without_load_{self.current_number}.csv"'
        self.EXPORT_FILE_with_load = fr' /E="C:\Users\D.Muehlfeld\Documents\Synthetic_Data\Synthetic_Data_Roughness\SyntheticData-Spechbach_Roughness_with_load_{self.current_number}.csv"'
