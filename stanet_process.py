...
class StanetProcess:
    def __init__(self, current_number, file_name):
        # Initialize the instance with the current number and file name
        ...
        self.TEXT_FILE = fr' /F="C:\Users\d.muehlfeld\weitere Daten\Synthetic_Data\13_Spechbach_RNAB_{self.current_number}.TXT"'

        # Define the export definition to be used
        self.EXPORT_DEFINITION = ' /Y="CSV"'

        # Define the path for the export file
        self.EXPORT_FILE = fr' /E="C:\Users\d.muehlfeld\weitere Daten\Synthetic_Data\export_results_{self.file_name}_{self.current_number}.csv"'
    ...
    def import_data(self):
        ...
        command_import = (f'"{self.STANET_PATH}"'
                          ...
                          ' /A'
                          f'{self.CALCULATE}')
        logging.info(f"Preparing to import data for number {self.current_number}")
    ...
    def export_data(self):
        ...
        command_export = (f'"{self.STANET_PATH}"'
                          ...
                          f'{self.EXPORT_FILE}'
                          f'{self.CALCULATE}')
        logging.info(f"Preparing to export data for number {self.current_number}")
